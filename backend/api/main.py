...
from backend.api.data import set_data_downloader, set_trading_engine as set_trading_engine_data, set_market_data_service
from backend.api.settings import set_settings_manager, set_notification_manager

def initialize_api_globals(trading_engine, backtest_engine, data_downloader, settings_manager, notification_manager, market_data_service):
